export default function Footer() {
  ...
  return (
    <footer className="bg-black border-t border-[#4300FF]/30">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              {/* Social Links */}
              <a href="#" className="text-gray-400 hover:text-[#00CAFF] transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#about" className="text-gray-400 hover:text-[#00CAFF] transition-colors duration-300">About Me</a></li>
              <li><a href="#skills" className="text-gray-400 hover:text-[#00CAFF] transition-colors duration-300">My Skills</a></li>
              <li><a href="#projects" className="text-gray-400 hover:text-[#00CAFF] transition-colors duration-300">My Projects</a></li>
              <li><a href="#contact" className="text-gray-400 hover:text-[#00CAFF] transition-colors duration-300">Contact Me</a></li>
            </ul>
          </div>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[#4300FF]/20">
